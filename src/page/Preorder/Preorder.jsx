...
export default function Quotation() {
  ...
  const exportToExcel = () => {
    ...
    customer_nameValue.value = `${data.customer_name}`;
    ...
    company_nameValue.value = `${data.company_name}`;
    ...
    placeValue.value = `หน้างาน - ${data.place_name}`;
    ...
    phoneValue.value = `${data.customer_tel}`;
    ...
    priceThb.value = formatThaiBahtText(data.final_price);
    ...
    const total_Price_Discount = total_Price_Out + data.move_price + data.shipping_cost - data.discount;

    const finalTotalPrice = (total_Price_Discount * 0.07) + data.guarantee_price + total_Price_Discount;
    ...
    guaranteePriceValue.value = `${formatNumber(data.guarantee_price)} `;
    ...
    discountValue.value = `${formatNumber(data.discount)} `;
    ...
    movePriceValue.value = `${formatNumber(data.move_price)} `;
    ...
    shippingCostValue.value = `${formatNumber(data.shipping_cost)} `;
    ...
    const newShippingCostPrice = (data.shipping_cost + data.move_price) * 0.03;
    const totalShippingCost = (data.shipping_cost + data.move_price) - newShippingCostPrice;
    ...
    payment61.value = formatNumber(data.shipping_cost + data.move_price);
