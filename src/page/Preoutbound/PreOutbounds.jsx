  ...
  return (
    <div className="w-screen h-auto p-2 mt-10 font-sarabun">
      ...
      <div className=" grid grid-cols-10 grid-rows-14 h-[300px] text-[9px]">
        ...
        <span className="col-span-1 row-span-1 border-b-2 border-black flex justify-end items-center print:text-[10px] pr-0.5 font-sarabun">{data.guarantee_price}.00</span>
